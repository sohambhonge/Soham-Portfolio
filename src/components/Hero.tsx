...
const socialLinks = [
  { icon: Github, href: "https://github.com/sohambhonge", label: "GitHub" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/sohambhonge?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", label: "LinkedIn" },
  ...
  <section className="min-h-screen flex items-center hero-bg pt-16">
    <div className="container grid md:grid-cols-2 gap-12 items-center py-20">
      ...
      <div className="order-1 md:order-2 flex justify-center">
        <div className="w-64 h-64 md:w-80 md:h-80 rounded-full profile-ring overflow-hidden">
          <img src={profileImg} alt="Soham Bhonge" className="w-full h-full object-cover object-[center_25%]" />
        </div>
      </div>
    </div>
  </section>
